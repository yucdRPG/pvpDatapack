...
schedule function aimatrix:games/maps/competitive/raid_s_q/map_preview3 19s append
schedule function aimatrix:games/maps/competitive/raid_s_q/map_preview4 25s append
schedule function aimatrix:games/maps/competitive/raid_s_q/map_preview5 28s append
schedule function aimatrix:games/maps/competitive/raid_s_q/1_tp_players 31s append
