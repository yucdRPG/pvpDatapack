...
schedule function aimatrix:games/maps/competitive/vondel_waterfront/map_preview3 19s append
schedule function aimatrix:games/maps/competitive/vondel_waterfront/map_preview4 25s append
schedule function aimatrix:games/maps/competitive/vondel_waterfront/map_preview5 28s append
schedule function aimatrix:games/maps/competitive/vondel_waterfront/1_tp_players 31s append
