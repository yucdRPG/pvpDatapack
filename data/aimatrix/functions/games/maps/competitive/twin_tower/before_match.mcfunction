...
schedule function aimatrix:games/maps/competitive/twin_tower/map_preview3 10s append
schedule function aimatrix:games/maps/competitive/twin_tower/map_preview4 13s append
schedule function aimatrix:games/maps/competitive/twin_tower/map_preview5 16s append
schedule function aimatrix:games/maps/competitive/twin_tower/1_tp_players 19s append
