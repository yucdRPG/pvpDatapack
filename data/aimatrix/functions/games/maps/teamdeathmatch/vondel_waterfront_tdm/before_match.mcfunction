...
schedule function aimatrix:games/maps/teamdeathmatch/vondel_waterfront_tdm/map_preview3 10s append
schedule function aimatrix:games/maps/teamdeathmatch/vondel_waterfront_tdm/map_preview4 13s append
schedule function aimatrix:games/maps/teamdeathmatch/vondel_waterfront_tdm/map_preview5 16s append
