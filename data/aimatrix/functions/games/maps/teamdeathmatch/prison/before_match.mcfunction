...
schedule function aimatrix:games/maps/teamdeathmatch/prison/map_preview3 23s append
schedule function aimatrix:games/maps/teamdeathmatch/prison/map_preview4 27s append
schedule function aimatrix:games/maps/teamdeathmatch/prison/map_preview5 30s append
