...
schedule function aimatrix:games/maps/teamdeathmatch/shoot_house/map_preview3 23s append
schedule function aimatrix:games/maps/teamdeathmatch/shoot_house/map_preview4 27s append
schedule function aimatrix:games/maps/teamdeathmatch/shoot_house/map_preview5 30s append
