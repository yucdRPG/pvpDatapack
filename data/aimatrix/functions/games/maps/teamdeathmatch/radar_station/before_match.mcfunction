...
schedule function aimatrix:games/maps/teamdeathmatch/radar_station/map_preview3 10s append
schedule function aimatrix:games/maps/teamdeathmatch/radar_station/map_preview4 13s append
schedule function aimatrix:games/maps/teamdeathmatch/radar_station/map_preview5 16s append
